...
VALUES
    ...
    ('Hellblade II: Senua''s Saga', 'Ninja Theory', 'Aventura', 0, 59.99, 25, 3, 3),
    ...
    ('Sea of Thieves', 'Rare', 'Aventura', 0, 39.99, 50, 3, 1),
    ...
    ('Ghost of Tsushima', 'Sucker Punch Productions', 'Aventura', 0, 49.99, 35, 1, 1),
    ...
    ('Stardew Valley', 'ConcernedApe', 'Simulación', 89, 14.99, 40, 8, 2);
