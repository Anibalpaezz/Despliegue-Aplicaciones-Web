 ...
 * @author Alejandro
 */
public class ComprobarUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try{
                ...
                if (laConexion.comprobarUsuario(usuario, pass)) {
                    ...
                    out.println("<form action='registroNuevoUsuario.jsp' method='post'>");
                    out.println("<input type='submit' name='registra' value='Registrar'>");
                    out.println("</form>");
                    out.println("</body>"); 
                    out.println("</html>");
                }else{
